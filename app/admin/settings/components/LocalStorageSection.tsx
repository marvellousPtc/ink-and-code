...
import { Image, FolderOpen, Loader2, CheckCircle2, XCircle, HelpCircle, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <div className="p-4 space-y-5 animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="grid gap-4">
            <AutoSaveField
              ...
              onSave={async (val) => await onUpdate({ storageType: val || null })}
              type="select"
              options={[
